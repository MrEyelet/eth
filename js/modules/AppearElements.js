...
class AppearElements {
  ...
  showElements() {
    ...
    this.tlShowElements.to(".hero__img-overlay", { duration: 0.5, scaleX: 0, transformOrigin: "right", ease: Power4.easeOut })
    this.tlShowElements.from(".header", { duration: 0.35, y: "-100%", ease: Power1.easeOut }, "=-1.5")
    setTimeout(() => {
