...
class AppearElements {
  ...
  showElements() {
    ...
    this.tlShowElements.from(".header", { duration: 0.35, y: "-100%", ease: Power1.easeOut }, "=-1")
    ...
    this.tlShowElements.from(".hero__img-overlay", { duration: 1, scaleX: 0, opacity: 0, transformOrigin: "left", ease: Power4.easeOut }, "=-1.4")
    ...
    this.tlShowElements.from(".socials a", { duration: 1.5, opacity: 0, y: "15%", stagger: 0.15, ease: Power4.easeOut }, "=-1.1")
    setTimeout(() => {
